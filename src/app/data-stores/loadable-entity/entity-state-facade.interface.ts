...
export namespace LoadableEntityFacade {
    ...
    export interface RefetchPageFacade {
        refetchPage(): void;
    }
    ...
    export class EntityFacadeBuilder<EntityType, CustomActionType = {}> {
        ...
        public addRefetchPageInterface(refetchAction: ActionCreator) {
            this._class = class extends this._class implements RefetchPageFacade {
                constructor(...args: any[]) {
                    super(...args);
                }
                refetchPage(): void {
        ...
        public addDeleteByKeyInterface<Key extends LoadableEntityTypeKey>(deleteEntityAction: Action): StoreConstructor<DeleteByKeyFacade<Key>> {
            return class extends this._class implements DeleteByKeyFacade<Key> {
                constructor(...args: any[]) {
                    super(...args);
                }
                deleteByKey(key: Key): void {
