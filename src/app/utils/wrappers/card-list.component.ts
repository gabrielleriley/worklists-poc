import { Component, Input, ChangeDetectionStrategy, Directive, ContentChildren, AfterContentInit, QueryList, ElementRef, OnDestroy, OnInit } from "@angular/core";
...
export class TableRowCheckbox implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.checkbox.checked = this.parent.getDefaultValue(this.checkboxId);
...
export class TableListSelectionContainerComponent implements OnInit {
    ...
    setPageSelectionStatus() {
        console.log('CHECK');
        console.log(this.registeredIds);
        ...
        if (someSelected) {
            ...
            return this.mainCheckbox.setChecked(false);
        }
    }
